...
export default class CreateStory extends Component {
  ...
  render() {
    if (!this.state.fontsLoaded) {
      ...
      let preview_images = {
        image_1: require("../assets/notas.jpg"),
        image_2: require("../assets/notas.jpg"),
        image_3: require("../assets/notas.jpg"),
        image_4: require("../assets/notas.jpg"),
        image_5: require("../assets/notas.jpg")
      };
      return (
        <View
          style={
        ...
        >
          ...
          <View style={styles.appTitle}>
            <View style={styles.appIcon}>
              <Image
                source={require("../assets/notas.jpg")}
